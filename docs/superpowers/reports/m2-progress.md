...
| ~~T34~~ | M2 门禁 | — | **已执行**（2026-09-01，编排者）：双报告 + 综合裁定 **GREEN（附条件）** + tag `m2`；集成守卫八项（1399×2 确定性、烟测、9000 装配校验、探针 PASS、存档 v2、导出冒烟、平衡复跑、卫生）见 `m2-gate-integration.md`；真人十项 checklist PENDING-USER 见 `m2-gate-playtest.md`（裁定㉛） | 真人试玩 → M3 前置 |
