# M2 Balance Bot 全层回归报告（2026-09-07 · Task 27 / H-1 · m2-t28）
...
- 局数：25（种子 3401..3425）｜崩溃：0｜超时中止：0
...
| 单局时长(均值/中位) | 3.2 / 3.1 min | 25.0~35.0 min（单局口径） | 第 1 层子集，仅参考 |

## 逐局

| seed | 结果 | 止步 | 房间 | 击杀 | 时长(min) | 金币 | 蓝晶 | 买红心 | 增益选择 | 首杀可获 | 死因 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 3401 | death | 第1层 | 11 | 49 | 2.7 | 110 | 25 | 0 | - | 是 | 藤蔓巨像的接触冲撞（miniboss） |
| 3402 | death | 第1层 | 11 | 49 | 3.0 | 158 | 25 | 0 | haggle | 是 | 藤蔓巨像的巨掌拍击（boss） |
| 3403 | death | 第1层 | 11 | 50 | 3.2 | 148 | 25 | 0 | - | 是 | 藤蔓巨像的种子弹环（boss） |
| 3404 | stalled | 第1层 | 7 | 40 | 4.9 | 27 | 5 | 0 | dash_extend | 是 | - |
| 3405 | death | 第1层 | 10 | 52 | 2.4 | 98 | 5 | 0 | - | 是 | 冰蛛的接触冲撞（miniboss） |
| 3406 | stalled | 第1层 | 10 | 46 | 5.1 | 98 | 5 | 0 | energy_siphon,nerve_reflex | 是 | - |
| 3407 | stalled | 第1层 | 5 | 25 | 4.3 | 11 | 5 | 0 | - | 是 | - |
| 3408 | death | 第1层 | 10 | 48 | 2.4 | 70 | 5 | 0 | quick_charge | 是 | 腐沼巨蟾的吐还弹幕（miniboss） |
| 3409 | death | 第1层 | 10 | 48 | 2.8 | 166 | 5 | 0 | swift_trigger | 是 | 腐沼巨蟾的吐还弹幕（miniboss） |
| 3410 | death | 第1层 | 10 | 48 | 2.7 | 136 | 5 | 0 | - | 是 | 腐沼巨蟾的吐还弹幕（miniboss） |
| 3411 | stalled | 第1层 | 11 | 49 | 4.7 | 138 | 25 | 0 | resonance_vision | 是 | - |
| 3412 | death | 第1层 | 11 | 49 | 3.5 | 107 | 25 | 1 | - | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3413 | death | 第1层 | 11 | 53 | 2.1 | 129 | 25 | 0 | status_erode | 是 | 藤蔓巨像的巨掌拍击（boss） |
| 3414 | death | 第1层 | 11 | 50 | 3.5 | 162 | 25 | 0 | haggle | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3415 | death | 第1层 | 11 | 50 | 3.3 | 89 | 25 | 0 | fire_enchant,nerve_reflex | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3416 | stalled | 第1层 | 4 | 21 | 4.1 | 79 | 0 | 1 | - | 是 | - |
| 3417 | death | 第1层 | 11 | 56 | 3.4 | 79 | 25 | 0 | roll_master | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3418 | death | 第1层 | 10 | 54 | 2.0 | 106 | 5 | 1 | ammo_convert,carapace | 是 | 苦力虫的自爆（miniboss） |
| 3419 | death | 第1层 | 11 | 53 | 2.2 | 169 | 25 | 0 | - | 是 | 藤蔓巨像的种子弹环（boss） |
| 3420 | death | 第1层 | 11 | 56 | 5.1 | 90 | 25 | 0 | roll_master,status_erode | 是 | 藤蔓巨像的毒雨（boss） |
| 3421 | death | 第1层 | 11 | 53 | 3.1 | 159 | 25 | 0 | deadly,vigor | 是 | 藤蔓巨像的种子弹环（boss） |
| 3422 | death | 第1层 | 6 | 39 | 1.4 | 77 | 0 | 0 | bullet_speed | 是 | 双刀蜥人的接触冲撞（elite） |
| 3423 | death | 第1层 | 10 | 48 | 2.5 | 57 | 5 | 0 | element_vision | 是 | 石盾武僧的接触冲撞（miniboss） |
| 3424 | death | 第1层 | 10 | 49 | 2.1 | 185 | 5 | 0 | thorn_armor,thorn_armor | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3425 | death | 第1层 | 11 | 49 | 4.9 | 110 | 25 | 0 | haggle,nerve_reflex | 是 | 蘑菇孢子手的减速孢子扇（boss） |
...
|---|---|---|---|
| A1 杂兵 TTK（首次受击→死亡） | 1.7 / 5.5 s (n=882) | ≤2.0 s | 达标 |
| A1 杂兵 lifetime（入场→死亡，旧口径对照） | 3.5 / 8.7 s (n=924) | - | 对照口径 |
| 精英击杀 | 2.0 / 20.6 s (n=165) | （参考） | - |
| 小 Boss 击杀 | 1.8 / 10.8 s (n=70) | （参考） | - |
| Boss 单体击杀 | 1.6 / 5.3 s (n=9) | （参考） | - |
| 战斗房时长 | 13.6 / 27.9 s (n=142) | 20.0~40.0 s | 偏离（目标 20.0~40.0 s） |
...
- 因子三（生存端）：死亡热房 F1:boss（11 次）。若集中于特定房型，建议校准该房型敌方弹幕密度（§7.5 上限）或弹速 -10%~15%；死亡集中于 Boss 房则复核 P2/P3 弹幕量曲线。
...
- **局间隔离**：每局 `start_run` 重置局内状态；SaveSystem 原状保留（headless 自动重定向 save_headless.json，真档不受影响）——图鉴/成就计数与 Boss 首杀标记跨局累积（真实玩家成长模拟），vine_colossus 首杀 +300 只落批次首局（逐局表「首杀可获」列可查）。m4-b3：并行实例经 `--save-suffix=<s>` 各写 `save_headless_<s>.json`（本批后缀='balg13'），消除图鉴/成就/首杀跨进程竞态。
