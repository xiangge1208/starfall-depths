...
- 局数：22（种子 3201..3296）｜崩溃：0｜超时中止：0
...
| 指标 | 实测 | §14.3 目标带 | 判定 |
|---|---|---|---|
| 生产胜率（第 3 层胜利） | 0/22 | 20%~40% | **不可评（本基线无 2/3 层内容）** |
| 内容上限到达率（win+milestone_a2） | 0% | -（本卡替代口径） | 有未走完局（超时/崩溃） |
| 单局时长(均值/中位) | 1.3 / 1.0 min | 25.0~35.0 min（单局口径） | 第 1 层子集，仅参考 |

## 逐局

| seed | 结果 | 止步 | 房间 | 击杀 | 时长(min) | 金币 | 蓝晶 | 买红心 | 增益选择 | 首杀可获 | 死因 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 3201 | death | 第1层 | 2 | 9 | 0.6 | 0 | 0 | 0 | - | 否 | 穴蝠的接触冲撞（elite） |
| 3206 | death | 第1层 | 1 | 7 | 0.6 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3210 | death | 第1层 | 4 | 20 | 3.3 | 0 | 5 | 0 | - | 否 | 藤蔓冲锋者的接触冲撞（combat） |
| 3214 | death | 第1层 | 1 | 10 | 1.0 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3219 | death | 第1层 | 2 | 7 | 0.6 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（elite） |
| 3225 | death | 第1层 | 3 | 16 | 1.1 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3229 | death | 第1层 | 1 | 8 | 0.4 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3234 | death | 第1层 | 4 | 22 | 3.1 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（elite） |
| 3238 | death | 第1层 | 3 | 19 | 1.0 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3242 | death | 第1层 | 1 | 8 | 0.8 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3246 | death | 第1层 | 0 | 2 | 0.2 | 0 | 0 | 0 | - | 否 | 弩兵的弹幕（combat） |
| 3250 | death | 第1层 | 1 | 7 | 0.7 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3255 | death | 第1层 | 6 | 35 | 2.5 | 18 | 5 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3260 | death | 第1层 | 3 | 12 | 1.5 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3265 | death | 第1层 | 3 | 23 | 1.4 | 0 | 0 | 0 | - | 否 | 弩兵的弹幕（combat） |
| 3270 | death | 第1层 | 2 | 15 | 1.0 | 0 | 0 | 0 | - | 否 | 双刀蜥人的接触冲撞（elite） |
| 3275 | death | 第1层 | 1 | 7 | 0.6 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3279 | death | 第1层 | 7 | 44 | 4.2 | 17 | 5 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3283 | death | 第1层 | 1 | 7 | 0.6 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3287 | death | 第1层 | 0 | 3 | 0.3 | 0 | 0 | 0 | - | 否 | 弩兵的弹幕（combat） |
| 3291 | death | 第1层 | 3 | 16 | 1.5 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3296 | death | 第1层 | 3 | 16 | 0.8 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
...
|---|---|---|---|
| A1 杂兵 TTK | 4.5 / 15.8 s (n=284) | ≤2.0 s | 偏离 |
| 精英击杀 | 5.4 / 29.7 s (n=29) | （参考） | - |
| 战斗房时长 | 24.0 / 47.5 s (n=39) | 20.0~40.0 s | 达标 |
...
- 因子一（输出端）：A1 杂兵 TTK 中位 4.5s 超出 §14.3「初始武器 ≤2.0s」。建议校准初始武器（laohuoji）基础伤害/攻速 +20%~30% 后复测。
- 因子三（生存端）：死亡热房 F1:combat（18 次）。若集中于特定房型，建议校准该房型敌方弹幕密度（§7.5 上限）或弹速 -10%~15%；死亡集中于 Boss 房则复核 P2/P3 弹幕量曲线。
