...
- 局数：25（种子 3476..3500）｜崩溃：0｜超时中止：0
...
| 单局时长(均值/中位) | 2.4 / 2.3 min | 25.0~35.0 min（单局口径） | 第 1 层子集，仅参考 |

## 逐局

| seed | 结果 | 止步 | 房间 | 击杀 | 时长(min) | 金币 | 蓝晶 | 买红心 | 增益选择 | 首杀可获 | 死因 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 3476 | death | 第1层 | 4 | 26 | 1.0 | 2 | 0 | 0 | - | 是 | 双刀蜥人的接触冲撞（elite） |
| 3477 | death | 第1层 | 4 | 29 | 1.2 | 6 | 0 | 0 | - | 是 | 双刀蜥人的接触冲撞（elite） |
| 3478 | death | 第1层 | 4 | 21 | 0.9 | 3 | 0 | 0 | - | 是 | 弩兵的接触冲撞（combat） |
| 3479 | death | 第1层 | 10 | 48 | 2.7 | 81 | 5 | 0 | crit_detonate | 是 | 石盾武僧的接触冲撞（miniboss） |
| 3480 | death | 第1层 | 10 | 48 | 2.4 | 94 | 5 | 0 | vigor | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3481 | death | 第1层 | 11 | 53 | 2.1 | 77 | 25 | 0 | - | 是 | 自爆王虫的延迟大爆（miniboss） |
| 3482 | death | 第1层 | 10 | 48 | 2.4 | 64 | 5 | 0 | avenger,shield_tune | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3483 | death | 第1层 | 11 | 50 | 2.9 | 80 | 25 | 0 | - | 是 | 藤蔓巨像的藤蔓横扫（boss） |
| 3484 | death | 第1层 | 10 | 48 | 2.4 | 62 | 5 | 0 | thorn_armor | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3485 | death | 第1层 | 10 | 48 | 2.7 | 63 | 5 | 0 | - | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3486 | death | 第1层 | 10 | 48 | 2.3 | 90 | 5 | 0 | - | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3487 | death | 第1层 | 10 | 51 | 2.2 | 81 | 5 | 0 | status_erode,shield_tune | 是 | 冰蛛的接触冲撞（miniboss） |
| 3488 | death | 第1层 | 10 | 49 | 2.0 | 70 | 5 | 0 | - | 是 | 冰蛛的接触冲撞（miniboss） |
| 3489 | death | 第1层 | 11 | 53 | 2.1 | 80 | 25 | 0 | avenger | 是 | 藤蔓巨像的巨掌拍击（boss） |
| 3490 | death | 第1层 | 10 | 48 | 2.3 | 93 | 5 | 0 | - | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3491 | death | 第1层 | 10 | 49 | 2.3 | 68 | 5 | 0 | shock_enchant | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3492 | death | 第1层 | 10 | 53 | 2.5 | 97 | 5 | 0 | - | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3493 | death | 第1层 | 10 | 54 | 2.5 | 58 | 5 | 0 | vigor,quick_charge | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3494 | death | 第1层 | 7 | 45 | 2.0 | 60 | 5 | 0 | heart_sense,thorn_armor | 是 | 藤蔓冲锋者的接触冲撞（combat） |
| 3495 | stalled | 第1层 | 5 | 31 | 4.4 | 40 | 5 | 0 | energy_siphon | 是 | - |
| 3496 | death | 第1层 | 11 | 51 | 3.2 | 42 | 25 | 0 | vigor,energy_max | 是 | 藤蔓巨像的藤蔓横扫（boss） |
| 3497 | death | 第1层 | 10 | 48 | 2.3 | 92 | 5 | 0 | resonance_amp,dash_extend | 是 | 石盾武僧的接触冲撞（miniboss） |
| 3498 | death | 第1层 | 11 | 50 | 3.7 | 57 | 25 | 1 | - | 是 | 藤蔓巨像的藤蔓横扫（boss） |
| 3499 | death | 第1层 | 10 | 50 | 2.2 | 99 | 5 | 0 | - | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3500 | death | 第1层 | 11 | 53 | 3.0 | 84 | 25 | 0 | thorn_armor,haggle | 是 | 蘑菇孢子手的减速孢子扇（boss） |
...
|---|---|---|---|
| A1 杂兵 TTK（首次受击→死亡） | 1.8 / 5.2 s (n=908) | ≤2.0 s | 达标 |
| A1 杂兵 lifetime（入场→死亡，旧口径对照） | 3.6 / 7.9 s (n=908) | - | 对照口径 |
| 精英击杀 | 2.7 / 20.3 s (n=164) | （参考） | - |
| 小 Boss 击杀 | 1.9 / 5.1 s (n=76) | （参考） | - |
| Boss 单体击杀 | 1.5 / 1.8 s (n=4) | （参考） | - |
| 战斗房时长 | 13.4 / 23.1 s (n=139) | 20.0~40.0 s | 偏离（目标 20.0~40.0 s） |
...
- 因子三（生存端）：死亡热房 F1:miniboss（15 次）。若集中于特定房型，建议校准该房型敌方弹幕密度（§7.5 上限）或弹速 -10%~15%；死亡集中于 Boss 房则复核 P2/P3 弹幕量曲线。
...
- **局间隔离**：每局 `start_run` 重置局内状态；SaveSystem 原状保留（headless 自动重定向 save_headless.json，真档不受影响）——图鉴/成就计数与 Boss 首杀标记跨局累积（真实玩家成长模拟），vine_colossus 首杀 +300 只落批次首局（逐局表「首杀可获」列可查）。m4-b3：并行实例经 `--save-suffix=<s>` 各写 `save_headless_<s>.json`（本批后缀='balg4'），消除图鉴/成就/首杀跨进程竞态。
