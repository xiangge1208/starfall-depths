...
| 单局时长(均值/中位) | 2.7 / 2.5 min | 25.0~35.0 min（单局口径） | 第 1 层子集，仅参考 |

## 逐局

| seed | 结果 | 止步 | 房间 | 击杀 | 时长(min) | 金币 | 蓝晶 | 买红心 | 增益选择 | 首杀可获 | 死因 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 3476 | death | 第1层 | 10 | 51 | 2.2 | 95 | 5 | 0 | crit_detonate | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3477 | stalled | 第1层 | 7 | 40 | 4.9 | 17 | 5 | 0 | - | 是 | - |
| 3478 | death | 第1层 | 11 | 54 | 2.3 | 79 | 25 | 0 | - | 是 | 藤蔓巨像的巨掌拍击（boss） |
| 3479 | death | 第1层 | 10 | 48 | 2.3 | 80 | 5 | 0 | crit_detonate | 是 | 石盾武僧的接触冲撞（miniboss） |
| 3480 | death | 第1层 | 11 | 50 | 4.5 | 83 | 25 | 0 | status_erode | 是 | 藤蔓巨像的种子弹环（boss） |
| 3481 | death | 第1层 | 4 | 22 | 1.0 | 1 | 0 | 0 | - | 是 | 双刀蜥人的接触冲撞（elite） |
| 3482 | death | 第1层 | 10 | 48 | 3.0 | 74 | 5 | 1 | avenger,vigor | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3483 | death | 第1层 | 11 | 50 | 3.1 | 75 | 25 | 0 | - | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3484 | death | 第1层 | 10 | 48 | 2.8 | 60 | 5 | 0 | thorn_armor | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3485 | death | 第1层 | 10 | 48 | 2.7 | 53 | 5 | 0 | - | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3486 | death | 第1层 | 10 | 48 | 2.5 | 56 | 5 | 0 | - | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3487 | stalled | 第1层 | 3 | 19 | 4.0 | 21 | 5 | 0 | status_erode | 是 | - |
| 3488 | death | 第1层 | 10 | 48 | 2.2 | 85 | 5 | 0 | - | 是 | 冰蛛的接触冲撞（miniboss） |
| 3489 | death | 第1层 | 11 | 50 | 2.0 | 92 | 25 | 0 | avenger | 是 | 自爆王虫的延迟大爆（miniboss） |
| 3490 | death | 第1层 | 3 | 19 | 0.9 | 7 | 0 | 0 | - | 是 | 双刀蜥人的接触冲撞（elite） |
| 3491 | death | 第1层 | 10 | 50 | 2.6 | 84 | 5 | 0 | shock_enchant | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3492 | death | 第1层 | 10 | 50 | 2.4 | 88 | 5 | 0 | - | 是 | 电磁蛛的电弧链（miniboss） |
| 3493 | death | 第1层 | 10 | 49 | 2.3 | 62 | 5 | 0 | vigor,quick_charge | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3494 | stalled | 第1层 | 10 | 46 | 5.2 | 98 | 5 | 0 | heart_sense,thorn_armor | 是 | - |
| 3495 | death | 第1层 | 11 | 50 | 3.1 | 55 | 25 | 0 | energy_siphon | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3496 | death | 第1层 | 11 | 52 | 2.2 | 57 | 25 | 0 | vigor,energy_max | 是 | 苦力虫的自爆（miniboss） |
| 3497 | death | 第1层 | 10 | 48 | 2.4 | 79 | 5 | 0 | resonance_amp,dash_extend | 是 | 石盾武僧的接触冲撞（miniboss） |
| 3498 | death | 第1层 | 10 | 48 | 2.5 | 83 | 5 | 0 | - | 是 | 石盾武僧的接触冲撞（miniboss） |
| 3499 | death | 第1层 | 10 | 53 | 2.7 | 70 | 5 | 0 | - | 是 | 电磁蛛的电弧链（miniboss） |
| 3500 | death | 第1层 | 10 | 51 | 2.1 | 78 | 5 | 0 | thorn_armor,haggle | 是 | 苦力虫的自爆（miniboss） |
...
|---|---|---|---|
| A1 杂兵 TTK（首次受击→死亡） | 1.8 / 5.4 s (n=897) | ≤2.0 s | 达标 |
| A1 杂兵 lifetime（入场→死亡，旧口径对照） | 3.6 / 8.2 s (n=897) | - | 对照口径 |
| 精英击杀 | 2.7 / 20.5 s (n=169) | （参考） | - |
| 小 Boss 击杀 | 1.7 / 5.0 s (n=69) | （参考） | - |
| Boss 单体击杀 | 1.3 / 1.4 s (n=3) | （参考） | - |
| 战斗房时长 | 13.7 / 24.6 s (n=138) | 20.0~40.0 s | 偏离（目标 20.0~40.0 s） |
...
- 因子三（生存端）：死亡热房 F1:miniboss（16 次）。若集中于特定房型，建议校准该房型敌方弹幕密度（§7.5 上限）或弹速 -10%~15%；死亡集中于 Boss 房则复核 P2/P3 弹幕量曲线。
...
- **局间隔离**：每局 `start_run` 重置局内状态；SaveSystem 原状保留（headless 自动重定向 save_headless.json，真档不受影响）——图鉴/成就计数与 Boss 首杀标记跨局累积（真实玩家成长模拟），vine_colossus 首杀 +300 只落批次首局（逐局表「首杀可获」列可查）。m4-b3：并行实例经 `--save-suffix=<s>` 各写 `save_headless_<s>.json`（本批后缀='balg8'），消除图鉴/成就/首杀跨进程竞态。
