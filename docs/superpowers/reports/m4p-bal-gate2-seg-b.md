...
- 局数：25（种子 3426..3450）｜崩溃：0｜超时中止：0
...
| 单局时长(均值/中位) | 2.6 / 2.5 min | 25.0~35.0 min（单局口径） | 第 1 层子集，仅参考 |

## 逐局

| seed | 结果 | 止步 | 房间 | 击杀 | 时长(min) | 金币 | 蓝晶 | 买红心 | 增益选择 | 首杀可获 | 死因 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 3426 | death | 第1层 | 10 | 48 | 2.4 | 78 | 5 | 0 | crit_detonate,precision | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3427 | death | 第1层 | 11 | 50 | 3.0 | 76 | 25 | 0 | energy_siphon | 是 | 藤蔓巨像的种子弹环（boss） |
| 3428 | death | 第1层 | 11 | 50 | 3.4 | 97 | 25 | 0 | crit_detonate | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3429 | death | 第1层 | 10 | 48 | 2.3 | 78 | 5 | 0 | vigor | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3430 | death | 第1层 | 4 | 21 | 1.0 | 2 | 0 | 0 | - | 是 | 弩兵的弹幕（elite） |
| 3431 | death | 第1层 | 11 | 50 | 3.3 | 119 | 25 | 0 | hunter | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3432 | death | 第1层 | 11 | 49 | 3.9 | 105 | 25 | 0 | - | 是 | 藤蔓巨像的巨掌拍击（boss） |
| 3433 | death | 第1层 | 11 | 49 | 2.6 | 91 | 25 | 0 | - | 是 | 藤蔓巨像的种子弹环（boss） |
| 3434 | death | 第1层 | 11 | 50 | 3.3 | 80 | 25 | 0 | nerve_reflex,status_erode | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3435 | death | 第1层 | 3 | 25 | 1.2 | 4 | 0 | 0 | - | 是 | 双刀蜥人的接触冲撞（elite） |
| 3436 | death | 第1层 | 10 | 48 | 2.4 | 42 | 5 | 0 | - | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3437 | death | 第1层 | 2 | 17 | 0.7 | 1 | 0 | 0 | - | 是 | 苦力虫的自爆（combat） |
| 3438 | death | 第1层 | 11 | 50 | 3.3 | 99 | 25 | 0 | swift_trigger | 是 | 藤蔓巨像的毒雨（boss） |
| 3439 | death | 第1层 | 11 | 50 | 3.5 | 85 | 25 | 0 | anti_poison | 是 | 藤蔓巨像的种子弹环（boss） |
| 3440 | death | 第1层 | 11 | 55 | 2.4 | 91 | 25 | 0 | - | 是 | 藤蔓巨像的接触冲撞（boss） |
| 3441 | death | 第1层 | 10 | 48 | 2.8 | 56 | 5 | 0 | extra_projectiles | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3442 | death | 第1层 | 11 | 49 | 2.5 | 113 | 25 | 0 | deadly,avenger | 是 | 藤蔓巨像的巨掌拍击（boss） |
| 3443 | death | 第1层 | 11 | 50 | 3.3 | 80 | 25 | 0 | - | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3444 | death | 第1层 | 11 | 51 | 3.6 | 97 | 25 | 0 | shield_tune | 是 | 藤蔓巨像的毒雨（boss） |
| 3445 | death | 第1层 | 5 | 26 | 1.1 | 12 | 0 | 0 | - | 是 | 弩兵的弹幕（elite） |
| 3446 | stalled | 第1层 | 4 | 22 | 4.2 | 25 | 5 | 0 | - | 是 | - |
| 3447 | death | 第1层 | 10 | 49 | 2.4 | 58 | 5 | 0 | - | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3448 | death | 第1层 | 11 | 53 | 2.4 | 94 | 25 | 0 | - | 是 | 藤蔓巨像的接触冲撞（miniboss） |
| 3449 | death | 第1层 | 5 | 32 | 1.7 | 11 | 0 | 0 | vigor | 是 | 双刀蜥人的接触冲撞（elite） |
| 3450 | death | 第1层 | 10 | 51 | 2.2 | 84 | 5 | 0 | swift_trigger | 是 | 电磁蛛的接触冲撞（miniboss） |
...
|---|---|---|---|
| A1 杂兵 TTK（首次受击→死亡） | 1.9 / 5.7 s (n=863) | ≤2.0 s | 达标 |
| A1 杂兵 lifetime（入场→死亡，旧口径对照） | 3.7 / 8.3 s (n=863) | - | 对照口径 |
| 精英击杀 | 3.1 / 20.6 s (n=154) | （参考） | - |
| 小 Boss 击杀 | 2.1 / 19.6 s (n=65) | （参考） | - |
| Boss 单体击杀 | 1.3 / 1.4 s (n=9) | （参考） | - |
| 战斗房时长 | 14.1 / 25.5 s (n=132) | 20.0~40.0 s | 偏离（目标 20.0~40.0 s） |
...
- 因子三（生存端）：死亡热房 F1:boss（12 次）。若集中于特定房型，建议校准该房型敌方弹幕密度（§7.5 上限）或弹速 -10%~15%；死亡集中于 Boss 房则复核 P2/P3 弹幕量曲线。
...
- **局间隔离**：每局 `start_run` 重置局内状态；SaveSystem 原状保留（headless 自动重定向 save_headless.json，真档不受影响）——图鉴/成就计数与 Boss 首杀标记跨局累积（真实玩家成长模拟），vine_colossus 首杀 +300 只落批次首局（逐局表「首杀可获」列可查）。m4-b3：并行实例经 `--save-suffix=<s>` 各写 `save_headless_<s>.json`（本批后缀='balg6'），消除图鉴/成就/首杀跨进程竞态。
