...
- 局数：31（种子 3205..3293）｜崩溃：0｜超时中止：0
...
| 指标 | 实测 | §14.3 目标带 | 判定 |
|---|---|---|---|
| 生产胜率（第 3 层胜利） | 0/31 | 20%~40% | **不可评（本基线无 2/3 层内容）** |
| 内容上限到达率（win+milestone_a2） | 0% | -（本卡替代口径） | 有未走完局（超时/崩溃） |
| 单局时长(均值/中位) | 1.7 / 1.2 min | 25.0~35.0 min（单局口径） | 第 1 层子集，仅参考 |

## 逐局

| seed | 结果 | 止步 | 房间 | 击杀 | 时长(min) | 金币 | 蓝晶 | 买红心 | 增益选择 | 首杀可获 | 死因 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 3205 | death | 第1层 | 1 | 13 | 0.8 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3205 | death | 第1层 | 10 | 49 | 5.8 | 42 | 5 | 0 | - | 否 | 电磁蛛的电弧链（miniboss） |
| 3205 | death | 第1层 | 1 | 14 | 1.5 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3217 | death | 第1层 | 5 | 32 | 2.3 | 8 | 5 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3217 | death | 第1层 | 0 | 7 | 0.5 | 0 | 0 | 0 | - | 否 | 藤蔓冲锋者的接触冲撞（combat） |
| 3217 | death | 第1层 | 0 | 7 | 0.7 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3221 | death | 第1层 | 4 | 21 | 1.5 | 0 | 5 | 0 | - | 否 | 弩兵的弹幕（combat） |
| 3221 | death | 第1层 | 3 | 13 | 1.1 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（elite） |
| 3221 | death | 第1层 | 3 | 13 | 0.8 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（elite） |
| 3223 | stalled | 第1层 | 0 | 5 | 1.6 | 0 | 0 | 0 | - | 否 | - |
| 3230 | death | 第1层 | 1 | 8 | 1.0 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3230 | death | 第1层 | 7 | 44 | 3.3 | 28 | 5 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3230 | death | 第1层 | 1 | 11 | 0.5 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3251 | death | 第1层 | 1 | 7 | 0.4 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3251 | death | 第1层 | 1 | 10 | 0.6 | 1 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3251 | death | 第1层 | 10 | 48 | 5.2 | 56 | 5 | 0 | - | 否 | 腐沼巨蟾的吐还弹幕（miniboss） |
| 3258 | death | 第1层 | 3 | 19 | 1.1 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3258 | death | 第1层 | 3 | 14 | 0.7 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3258 | death | 第1层 | 5 | 28 | 3.1 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（elite） |
| 3262 | death | 第1层 | 5 | 28 | 1.8 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3262 | death | 第1层 | 11 | 49 | 4.5 | 41 | 25 | 0 | - | 否 | 藤蔓巨像的藤蔓横扫（boss） |
| 3262 | death | 第1层 | 4 | 19 | 1.5 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3268 | death | 第1层 | 4 | 19 | 2.7 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3268 | death | 第1层 | 4 | 19 | 1.7 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3268 | death | 第1层 | 4 | 19 | 1.2 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3271 | death | 第1层 | 1 | 10 | 0.6 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3271 | death | 第1层 | 1 | 10 | 0.6 | 4 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3271 | stalled | 第1层 | 3 | 19 | 2.1 | 0 | 5 | 0 | - | 否 | - |
| 3293 | death | 第1层 | 1 | 10 | 1.0 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3293 | death | 第1层 | 1 | 13 | 0.7 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
| 3293 | death | 第1层 | 3 | 22 | 1.4 | 0 | 0 | 0 | - | 否 | 苦力虫的自爆（combat） |
...
|---|---|---|---|
| A1 杂兵 TTK | 4.7 / 14.4 s (n=540) | ≤2.0 s | 偏离 |
| 精英击杀 | 5.4 / 29.2 s (n=52) | （参考） | - |
| 小 Boss 击杀 | 4.2 / 34.4 s (n=8) | （参考） | - |
| 战斗房时长 | 22.9 / 46.0 s (n=71) | 20.0~40.0 s | 达标 |
...
- 因子一（输出端）：A1 杂兵 TTK 中位 4.7s 超出 §14.3「初始武器 ≤2.0s」。建议校准初始武器（laohuoji）基础伤害/攻速 +20%~30% 后复测。
- 因子三（生存端）：死亡热房 F1:combat（23 次）。若集中于特定房型，建议校准该房型敌方弹幕密度（§7.5 上限）或弹速 -10%~15%；死亡集中于 Boss 房则复核 P2/P3 弹幕量曲线。
