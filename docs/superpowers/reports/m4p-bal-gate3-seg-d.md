...
| 单局时长(均值/中位) | 2.7 / 2.4 min | 25.0~35.0 min（单局口径） | 第 1 层子集，仅参考 |

## 逐局

| seed | 结果 | 止步 | 房间 | 击杀 | 时长(min) | 金币 | 蓝晶 | 买红心 | 增益选择 | 首杀可获 | 死因 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 3476 | death | 第1层 | 10 | 48 | 2.3 | 93 | 5 | 0 | crit_detonate | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3477 | stalled | 第1层 | 10 | 46 | 4.9 | 106 | 5 | 0 | - | 是 | - |
| 3478 | stalled | 第1层 | 6 | 36 | 4.6 | 108 | 5 | 0 | - | 是 | - |
| 3479 | stalled | 第1层 | 6 | 31 | 4.5 | 7 | 5 | 0 | - | 是 | - |
| 3480 | death | 第1层 | 10 | 48 | 4.3 | 97 | 5 | 0 | status_erode | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3481 | death | 第1层 | 11 | 59 | 4.5 | 151 | 25 | 0 | - | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3482 | death | 第1层 | 3 | 25 | 0.9 | 91 | 0 | 0 | avenger | 是 | 藤蔓冲锋者的接触冲撞（elite） |
| 3483 | death | 第1层 | 3 | 16 | 0.7 | 1 | 0 | 0 | - | 是 | 双刀蜥人的接触冲撞（elite） |
| 3484 | death | 第1层 | 4 | 20 | 0.9 | 3 | 5 | 0 | thorn_armor | 是 | 藤蔓冲锋者的接触冲撞（combat） |
| 3485 | death | 第1层 | 5 | 32 | 1.3 | 10 | 0 | 0 | - | 是 | 双刀蜥人的接触冲撞（elite） |
| 3486 | death | 第1层 | 10 | 48 | 2.0 | 105 | 5 | 1 | - | 是 | 腐沼巨蟾的吐还弹幕（miniboss） |
| 3487 | stalled | 第1层 | 3 | 19 | 4.0 | 24 | 5 | 0 | status_erode | 是 | - |
| 3488 | death | 第1层 | 10 | 50 | 2.4 | 107 | 5 | 0 | - | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3489 | death | 第1层 | 11 | 52 | 4.0 | 153 | 25 | 0 | avenger | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3490 | death | 第1层 | 10 | 48 | 2.4 | 116 | 5 | 1 | - | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3491 | death | 第1层 | 10 | 49 | 2.1 | 162 | 5 | 0 | shock_enchant | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3492 | death | 第1层 | 10 | 48 | 2.1 | 102 | 5 | 0 | - | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3493 | death | 第1层 | 10 | 48 | 2.7 | 165 | 5 | 0 | vigor,quick_charge | 是 | 冰蛛的接触冲撞（miniboss） |
| 3494 | death | 第1层 | 10 | 48 | 2.5 | 158 | 5 | 0 | heart_sense,thorn_armor | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3495 | death | 第1层 | 11 | 49 | 2.2 | 149 | 25 | 0 | energy_siphon | 是 | 藤蔓巨像的巨掌拍击（boss） |
| 3496 | death | 第1层 | 3 | 24 | 1.2 | 3 | 0 | 0 | vigor | 是 | 双刀蜥人的接触冲撞（elite） |
| 3497 | stalled | 第1层 | 5 | 25 | 4.1 | 10 | 5 | 0 | resonance_amp | 是 | - |
| 3498 | death | 第1层 | 11 | 50 | 3.5 | 151 | 25 | 0 | - | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3499 | death | 第1层 | 10 | 50 | 2.3 | 49 | 5 | 0 | - | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3500 | death | 第1层 | 6 | 34 | 1.6 | 96 | 5 | 0 | thorn_armor | 是 | 藤蔓冲锋者的接触冲撞（combat） |
...
|---|---|---|---|
| A1 杂兵 TTK（首次受击→死亡） | 1.7 / 6.3 s (n=744) | ≤2.0 s | 达标 |
| A1 杂兵 lifetime（入场→死亡，旧口径对照） | 3.5 / 8.3 s (n=786) | - | 对照口径 |
| 精英击杀 | 2.3 / 19.7 s (n=158) | （参考） | - |
| 小 Boss 击杀 | 1.4 / 12.5 s (n=38) | （参考） | - |
| Boss 单体击杀 | 1.0 / 6.7 s (n=6) | （参考） | - |
| 战斗房时长 | 13.2 / 25.4 s (n=121) | 20.0~40.0 s | 偏离（目标 20.0~40.0 s） |
...
- 因子三（生存端）：死亡热房 F1:miniboss（10 次）。若集中于特定房型，建议校准该房型敌方弹幕密度（§7.5 上限）或弹速 -10%~15%；死亡集中于 Boss 房则复核 P2/P3 弹幕量曲线。
...
- **局间隔离**：每局 `start_run` 重置局内状态；SaveSystem 原状保留（headless 自动重定向 save_headless.json，真档不受影响）——图鉴/成就计数与 Boss 首杀标记跨局累积（真实玩家成长模拟），vine_colossus 首杀 +300 只落批次首局（逐局表「首杀可获」列可查）。m4-b3：并行实例经 `--save-suffix=<s>` 各写 `save_headless_<s>.json`（本批后缀='balg12'），消除图鉴/成就/首杀跨进程竞态。
