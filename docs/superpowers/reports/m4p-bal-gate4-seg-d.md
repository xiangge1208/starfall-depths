...
|---|---|---|---|---|---|---|---|---|---|---|---|
| 3476 | stalled | 第1层 | 5 | 28 | 4.3 | 20 | 5 | 0 | - | 是 | - |
| 3477 | death | 第1层 | 11 | 51 | 3.0 | 129 | 25 | 0 | - | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3478 | death | 第1层 | 11 | 52 | 2.1 | 157 | 25 | 0 | - | 是 | 苦力虫的自爆（miniboss） |
| 3479 | death | 第1层 | 10 | 48 | 2.4 | 75 | 5 | 0 | crit_detonate | 是 | 石盾武僧的接触冲撞（miniboss） |
| 3480 | stalled | 第1层 | 10 | 46 | 6.2 | 90 | 5 | 0 | status_erode | 是 | - |
| 3481 | death | 第1层 | 10 | 53 | 3.1 | 145 | 5 | 0 | - | 是 | 苦力虫的自爆（miniboss） |
| 3482 | death | 第1层 | 10 | 48 | 2.5 | 113 | 5 | 0 | avenger,shield_tune | 是 | 腐沼巨蟾的吐还弹幕（miniboss） |
| 3483 | stalled | 第1层 | 11 | 49 | 5.0 | 193 | 25 | 0 | - | 是 | - |
| 3484 | death | 第1层 | 10 | 48 | 2.7 | 76 | 5 | 0 | thorn_armor | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3485 | death | 第1层 | 10 | 48 | 2.9 | 84 | 5 | 0 | - | 是 | 腐沼巨蟾的吐还弹幕（miniboss） |
| 3486 | death | 第1层 | 2 | 14 | 0.6 | 0 | 0 | 0 | - | 是 | 弩兵的弹幕（combat） |
| 3487 | death | 第1层 | 2 | 18 | 0.9 | 1 | 0 | 0 | status_erode | 是 | 双刀蜥人的接触冲撞（elite） |
| 3488 | death | 第1层 | 10 | 54 | 2.5 | 153 | 5 | 0 | - | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3489 | death | 第1层 | 10 | 52 | 2.3 | 181 | 5 | 0 | avenger | 是 | 苦力虫的自爆（miniboss） |
| 3490 | death | 第1层 | 10 | 48 | 2.3 | 145 | 5 | 0 | - | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3491 | death | 第1层 | 10 | 49 | 2.2 | 174 | 5 | 0 | shock_enchant | 是 | 电磁蛛的电弧链（miniboss） |
| 3492 | death | 第1层 | 10 | 50 | 2.3 | 90 | 5 | 0 | - | 是 | 冰蛛的接触冲撞（miniboss） |
| 3493 | death | 第1层 | 10 | 51 | 2.5 | 54 | 5 | 0 | vigor,quick_charge | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3494 | stalled | 第1层 | 5 | 28 | 4.4 | 95 | 5 | 1 | heart_sense | 是 | - |
| 3495 | stalled | 第1层 | 5 | 31 | 4.4 | 32 | 5 | 0 | energy_siphon | 是 | - |
| 3496 | death | 第1层 | 3 | 23 | 0.8 | 2 | 0 | 0 | vigor | 是 | 双刀蜥人的接触冲撞（elite） |
| 3497 | death | 第1层 | 10 | 48 | 2.5 | 112 | 5 | 0 | resonance_amp,dash_extend | 是 | 石盾武僧的接触冲撞（miniboss） |
| 3498 | death | 第1层 | 10 | 48 | 1.9 | 154 | 5 | 0 | - | 是 | 石盾武僧的接触冲撞（miniboss） |
| 3499 | death | 第1层 | 10 | 51 | 2.3 | 58 | 5 | 0 | - | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3500 | death | 第1层 | 11 | 53 | 2.2 | 61 | 25 | 0 | thorn_armor,haggle | 是 | 自爆王虫的延迟大爆（boss） |
...
|---|---|---|---|
| A1 杂兵 TTK（首次受击→死亡） | 1.6 / 5.6 s (n=827) | ≤2.0 s | 达标 |
| A1 杂兵 lifetime（入场→死亡，旧口径对照） | 3.4 / 8.7 s (n=851) | - | 对照口径 |
| 精英击杀 | 2.4 / 20.6 s (n=164) | （参考） | - |
| 小 Boss 击杀 | 1.6 / 9.3 s (n=65) | （参考） | - |
| Boss 单体击杀 | 2.9 / 2.9 s (n=2) | （参考） | - |
| 战斗房时长 | 13.4 / 28.9 s (n=131) | 20.0~40.0 s | 偏离（目标 20.0~40.0 s） |
...
- **局间隔离**：每局 `start_run` 重置局内状态；SaveSystem 原状保留（headless 自动重定向 save_headless.json，真档不受影响）——图鉴/成就计数与 Boss 首杀标记跨局累积（真实玩家成长模拟），vine_colossus 首杀 +300 只落批次首局（逐局表「首杀可获」列可查）。m4-b3：并行实例经 `--save-suffix=<s>` 各写 `save_headless_<s>.json`（本批后缀='balg16'），消除图鉴/成就/首杀跨进程竞态。
