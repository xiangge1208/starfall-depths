...
| 单局时长(均值/中位) | 3.3 / 2.8 min | 25.0~35.0 min（单局口径） | 第 1 层子集，仅参考 |

## 逐局

| seed | 结果 | 止步 | 房间 | 击杀 | 时长(min) | 金币 | 蓝晶 | 买红心 | 增益选择 | 首杀可获 | 死因 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 3401 | death | 第1层 | 11 | 50 | 3.3 | 93 | 25 | 0 | - | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3402 | death | 第1层 | 5 | 28 | 1.1 | 0 | 0 | 0 | haggle | 是 | 双刀蜥人的接触冲撞（elite） |
| 3403 | death | 第1层 | 11 | 49 | 2.6 | 150 | 25 | 0 | - | 是 | 藤蔓巨像的接触冲撞（boss） |
| 3404 | stalled | 第1层 | 7 | 41 | 5.1 | 70 | 5 | 0 | dash_extend | 是 | - |
| 3405 | death | 第1层 | 10 | 51 | 2.2 | 96 | 5 | 0 | - | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3406 | stalled | 第1层 | 7 | 42 | 4.9 | 42 | 5 | 0 | energy_siphon,nerve_reflex | 是 | - |
| 3407 | death | 第1层 | 10 | 51 | 2.4 | 113 | 5 | 0 | - | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3408 | stalled | 第1层 | 5 | 26 | 5.3 | 41 | 5 | 0 | - | 是 | - |
| 3409 | stalled | 第1层 | 3 | 15 | 4.0 | 15 | 5 | 0 | - | 是 | - |
| 3410 | death | 第1层 | 10 | 48 | 2.8 | 118 | 5 | 0 | - | 是 | 腐沼巨蟾的吐还弹幕（miniboss） |
| 3411 | death | 第1层 | 11 | 50 | 2.3 | 155 | 25 | 0 | resonance_vision | 是 | 藤蔓巨像的种子弹环（boss） |
| 3412 | death | 第1层 | 11 | 49 | 2.5 | 79 | 25 | 0 | - | 是 | 藤蔓巨像的种子弹环（boss） |
| 3413 | death | 第1层 | 11 | 52 | 2.0 | 132 | 25 | 0 | status_erode | 是 | 苦力虫的自爆（miniboss） |
| 3414 | death | 第1层 | 11 | 49 | 2.8 | 158 | 25 | 0 | haggle | 是 | 藤蔓巨像的巨掌拍击（boss） |
| 3415 | stalled | 第1层 | 6 | 32 | 4.6 | 22 | 5 | 0 | fire_enchant | 是 | - |
| 3416 | stalled | 第1层 | 5 | 28 | 4.2 | 94 | 5 | 1 | - | 是 | - |
| 3417 | death | 第1层 | 2 | 12 | 0.5 | 1 | 0 | 0 | - | 是 | 藤蔓冲锋者的接触冲撞（combat） |
| 3418 | death | 第1层 | 11 | 53 | 2.1 | 136 | 25 | 0 | ammo_convert,carapace | 是 | 藤蔓巨像的接触冲撞（boss） |
| 3419 | death | 第1层 | 11 | 52 | 1.9 | 165 | 25 | 0 | - | 是 | 自爆王虫的延迟大爆（miniboss） |
| 3420 | stalled | 第1层 | 6 | 36 | 10.0 | 118 | 5 | 0 | roll_master,status_erode | 是 | - |
| 3421 | death | 第1层 | 6 | 37 | 1.7 | 61 | 0 | 1 | deadly | 是 | 双刀蜥人的接触冲撞（elite） |
| 3422 | death | 第1层 | 11 | 55 | 3.6 | 140 | 25 | 0 | bullet_speed | 是 | 藤蔓巨像的种子弹环（boss） |
| 3423 | death | 第1层 | 11 | 49 | 3.1 | 61 | 25 | 0 | element_vision | 是 | 藤蔓巨像的巨掌拍击（boss） |
| 3424 | stalled | 第1层 | 10 | 46 | 5.1 | 169 | 5 | 0 | thorn_armor,thorn_armor | 是 | - |
| 3425 | death | 第1层 | 10 | 48 | 2.0 | 114 | 5 | 0 | haggle,nerve_reflex | 是 | 石盾武僧的接触冲撞（miniboss） |
...
|---|---|---|---|
| A1 杂兵 TTK（首次受击→死亡） | 1.6 / 5.5 s (n=795) | ≤2.0 s | 达标 |
| A1 杂兵 lifetime（入场→死亡，旧口径对照） | 3.4 / 8.3 s (n=825) | - | 对照口径 |
| 精英击杀 | 2.0 / 20.7 s (n=161) | （参考） | - |
| 小 Boss 击杀 | 1.9 / 13.7 s (n=51) | （参考） | - |
| Boss 单体击杀 | 1.2 / 2.5 s (n=8) | （参考） | - |
| 战斗房时长 | 13.7 / 23.9 s (n=126) | 20.0~40.0 s | 偏离（目标 20.0~40.0 s） |
...
- 因子三（生存端）：死亡热房 F1:boss（8 次）。若集中于特定房型，建议校准该房型敌方弹幕密度（§7.5 上限）或弹速 -10%~15%；死亡集中于 Boss 房则复核 P2/P3 弹幕量曲线。
...
- **局间隔离**：每局 `start_run` 重置局内状态；SaveSystem 原状保留（headless 自动重定向 save_headless.json，真档不受影响）——图鉴/成就计数与 Boss 首杀标记跨局累积（真实玩家成长模拟），vine_colossus 首杀 +300 只落批次首局（逐局表「首杀可获」列可查）。m4-b3：并行实例经 `--save-suffix=<s>` 各写 `save_headless_<s>.json`（本批后缀='balg9'），消除图鉴/成就/首杀跨进程竞态。
