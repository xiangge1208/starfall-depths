# M2 Balance Bot 全层回归报告（2026-09-06 · Task 27 / H-1 · m2-t28）
...
- 局数：25（种子 3451..3475）｜崩溃：0｜超时中止：0
...
| 指标 | 实测 | §14.3 目标带 | 判定 |
|---|---|---|---|
| 生产胜率（第 3 层胜利） | 0/25 | 20%~40% | **不可评（本基线无 2/3 层内容）** |
| 内容上限到达率（win+milestone_a2） | 0% | -（本卡替代口径） | 有未走完局（超时/崩溃） |
| 单局时长(均值/中位) | 2.9 / 2.6 min | 25.0~35.0 min（单局口径） | 第 1 层子集，仅参考 |

## 逐局

| seed | 结果 | 止步 | 房间 | 击杀 | 时长(min) | 金币 | 蓝晶 | 买红心 | 增益选择 | 首杀可获 | 死因 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 3451 | death | 第1层 | 11 | 49 | 2.6 | 95 | 25 | 0 | roll_master | 是 | 藤蔓巨像的种子弹环（boss） |
| 3452 | death | 第1层 | 10 | 48 | 2.6 | 57 | 5 | 0 | haggle,element_vision | 是 | 腐沼巨蟾的吐还弹幕（miniboss） |
| 3453 | death | 第1层 | 10 | 48 | 3.0 | 83 | 5 | 0 | - | 是 | 腐沼巨蟾的吐还弹幕（miniboss） |
| 3454 | death | 第1层 | 11 | 51 | 3.5 | 82 | 25 | 0 | swift_trigger | 是 | 藤蔓巨像的种子弹环（boss） |
| 3455 | death | 第1层 | 11 | 49 | 2.9 | 143 | 25 | 0 | - | 是 | 藤蔓巨像的藤蔓横扫（boss） |
| 3456 | death | 第1层 | 10 | 49 | 2.2 | 87 | 5 | 0 | haggle | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3457 | death | 第1层 | 11 | 51 | 3.5 | 87 | 25 | 0 | shield_tune,element_vision | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3458 | death | 第1层 | 10 | 48 | 2.3 | 82 | 5 | 0 | shield_tune | 是 | 电磁蛛的电弧链（miniboss） |
| 3459 | death | 第1层 | 11 | 49 | 2.5 | 106 | 25 | 0 | - | 是 | 藤蔓巨像的接触冲撞（boss） |
| 3460 | death | 第1层 | 11 | 53 | 2.2 | 84 | 25 | 0 | resonance_amp | 是 | 藤蔓巨像的接触冲撞（miniboss） |
| 3461 | death | 第1层 | 10 | 49 | 2.2 | 92 | 5 | 0 | - | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3462 | death | 第1层 | 11 | 49 | 2.7 | 85 | 25 | 0 | - | 是 | 藤蔓巨像的巨掌拍击（boss） |
| 3463 | death | 第1层 | 10 | 48 | 2.2 | 84 | 5 | 0 | ammo_convert,resonance_vision | 是 | 石盾武僧的接触冲撞（miniboss） |
| 3464 | stalled | 第1层 | 10 | 46 | 4.9 | 88 | 5 | 0 | - | 是 | - |
| 3465 | death | 第1层 | 11 | 50 | 3.1 | 41 | 25 | 0 | - | 是 | 藤蔓巨像的藤蔓横扫（boss） |
| 3466 | death | 第1层 | 10 | 51 | 2.4 | 102 | 5 | 0 | haggle,vigor | 是 | 冰蛛的接触冲撞（miniboss） |
| 3467 | death | 第1层 | 11 | 50 | 3.3 | 80 | 25 | 0 | nerve_reflex | 是 | 藤蔓巨像的藤蔓横扫（boss） |
| 3468 | death | 第1层 | 11 | 50 | 2.9 | 107 | 25 | 0 | crit_detonate,dash_extend | 是 | 藤蔓巨像的藤蔓横扫（boss） |
| 3469 | death | 第1层 | 11 | 50 | 3.6 | 40 | 25 | 0 | energy_max,hunter | 是 | 藤蔓巨像的藤蔓横扫（boss） |
| 3470 | death | 第1层 | 10 | 52 | 2.5 | 84 | 5 | 0 | - | 是 | 电磁蛛的电弧链（miniboss） |
| 3471 | death | 第1层 | 10 | 48 | 2.5 | 89 | 5 | 0 | vigor | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3472 | stalled | 第1层 | 6 | 31 | 4.3 | 25 | 5 | 0 | - | 是 | - |
| 3473 | death | 第1层 | 11 | 53 | 2.3 | 75 | 25 | 0 | carapace | 是 | 藤蔓巨像的接触冲撞（miniboss） |
| 3474 | death | 第1层 | 11 | 49 | 3.1 | 115 | 25 | 0 | phoenix,shield_tune | 是 | 藤蔓巨像的种子弹环（boss） |
| 3475 | death | 第1层 | 10 | 50 | 2.3 | 68 | 5 | 0 | phoenix | 是 | 电磁蛛的接触冲撞（miniboss） |
...
- 口径（m4p-bal-b）：ttk = 首次受击→死亡（§14.3「持续输出击杀 ≤2.0s」语义，bot 侧 hp 轮询，剔除入场后排队的等待时间；DoT 击杀等无 first_hit 记录者不计入）；lifetime = 入场→死亡（旧口径，全量入账，供 before/after 对照）。

| 指标 | 实测(中位/p90) | §14.3 目标 | 判定 |
|---|---|---|---|
| A1 杂兵 TTK（首次受击→死亡） | 1.8 / 5.3 s (n=960) | ≤2.0 s | 达标 |
| A1 杂兵 lifetime（入场→死亡，旧口径对照） | 3.7 / 8.1 s (n=960) | - | 对照口径 |
| 精英击杀 | 2.7 / 20.6 s (n=175) | （参考） | - |
| 小 Boss 击杀 | 1.9 / 18.9 s (n=78) | （参考） | - |
| Boss 单体击杀 | 1.5 / 1.5 s (n=8) | （参考） | - |
| 战斗房时长 | 13.7 / 23.9 s (n=148) | 20.0~40.0 s | 偏离（目标 20.0~40.0 s） |
...
- **局间隔离**：每局 `start_run` 重置局内状态；SaveSystem 原状保留（headless 自动重定向 save_headless.json，真档不受影响）——图鉴/成就计数与 Boss 首杀标记跨局累积（真实玩家成长模拟），vine_colossus 首杀 +300 只落批次首局（逐局表「首杀可获」列可查）。m4-b3：并行实例经 `--save-suffix=<s>` 各写 `save_headless_<s>.json`（本批后缀='balg3'），消除图鉴/成就/首杀跨进程竞态。
