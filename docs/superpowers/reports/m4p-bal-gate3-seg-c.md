...
| 单局时长(均值/中位) | 3.8 / 2.7 min | 25.0~35.0 min（单局口径） | 第 1 层子集，仅参考 |

## 逐局

| seed | 结果 | 止步 | 房间 | 击杀 | 时长(min) | 金币 | 蓝晶 | 买红心 | 增益选择 | 首杀可获 | 死因 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 3451 | death | 第1层 | 11 | 49 | 1.6 | 177 | 25 | 0 | roll_master | 是 | 藤蔓巨像的种子弹环（boss） |
| 3452 | stalled | 第1层 | 1 | 10 | 4.0 | 90 | 0 | 0 | haggle | 是 | - |
| 3453 | death | 第1层 | 10 | 48 | 2.6 | 64 | 5 | 1 | - | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3454 | death | 第1层 | 11 | 49 | 4.3 | 154 | 25 | 0 | swift_trigger | 是 | 藤蔓巨像的巨掌拍击（boss） |
| 3455 | death | 第1层 | 11 | 50 | 3.3 | 100 | 25 | 0 | - | 是 | 藤蔓巨像的种子弹环（boss） |
| 3456 | death | 第1层 | 10 | 57 | 2.4 | 177 | 5 | 0 | haggle | 是 | 冰蛛的接触冲撞（miniboss） |
| 3457 | death | 第1层 | 11 | 50 | 3.3 | 108 | 25 | 1 | shield_tune,element_vision | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3458 | death | 第1层 | 10 | 54 | 2.6 | 148 | 5 | 0 | shield_tune | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3459 | stalled | 第1层 | 5 | 28 | 4.2 | 99 | 5 | 0 | - | 是 | - |
| 3460 | stalled | 第1层 | 6 | 36 | 6.4 | 124 | 5 | 0 | - | 是 | - |
| 3461 | death | 第1层 | 10 | 48 | 2.3 | 137 | 5 | 0 | - | 是 | 冰蛛的接触冲撞（miniboss） |
| 3462 | stalled | 第1层 | 11 | 49 | 5.6 | 123 | 25 | 0 | - | 是 | - |
| 3463 | stalled | 第1层 | 7 | 42 | 10.6 | 141 | 5 | 0 | ammo_convert | 是 | - |
| 3464 | death | 第1层 | 11 | 57 | 2.3 | 151 | 25 | 1 | - | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3465 | death | 第1层 | 11 | 50 | 2.3 | 108 | 25 | 0 | - | 是 | 藤蔓巨像的毒雨（boss） |
| 3466 | death | 第1层 | 10 | 56 | 2.7 | 153 | 5 | 0 | haggle,shield_tune | 是 | 冰蛛的接触冲撞（miniboss） |
| 3467 | death | 第1层 | 11 | 49 | 2.7 | 144 | 25 | 0 | nerve_reflex | 是 | 藤蔓巨像的种子弹环（boss） |
| 3468 | stalled | 第1层 | 11 | 49 | 5.9 | 90 | 25 | 0 | crit_detonate,dash_extend | 是 | - |
| 3469 | death | 第1层 | 10 | 48 | 2.3 | 133 | 5 | 0 | energy_max,hunter | 是 | 石盾武僧的接触冲撞（miniboss） |
| 3470 | death | 第1层 | 10 | 48 | 2.3 | 75 | 5 | 0 | - | 是 | 冰蛛的接触冲撞（miniboss） |
| 3471 | death | 第1层 | 10 | 48 | 2.7 | 158 | 5 | 0 | vigor | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3472 | death | 第1层 | 10 | 48 | 2.4 | 83 | 5 | 0 | haggle | 是 | 石盾武僧的接触冲撞（miniboss） |
| 3473 | death | 第1层 | 11 | 53 | 2.4 | 166 | 25 | 0 | carapace | 是 | 藤蔓巨像的巨掌拍击（boss） |
| 3474 | stalled | 第1层 | 10 | 46 | 5.2 | 114 | 5 | 0 | phoenix,shield_tune | 是 | - |
| 3475 | stalled | 第1层 | 4 | 29 | 8.9 | 115 | 0 | 0 | phoenix | 是 | - |
...
|---|---|---|---|
| A1 杂兵 TTK（首次受击→死亡） | 1.6 / 5.5 s (n=855) | ≤2.0 s | 达标 |
| A1 杂兵 lifetime（入场→死亡，旧口径对照） | 3.4 / 8.5 s (n=904) | - | 对照口径 |
| 精英击杀 | 2.3 / 20.2 s (n=146) | （参考） | - |
| 小 Boss 击杀 | 1.9 / 17.5 s (n=76) | （参考） | - |
| Boss 单体击杀 | 1.6 / 1.6 s (n=2) | （参考） | - |
| 战斗房时长 | 13.9 / 26.3 s (n=137) | 20.0~40.0 s | 偏离（目标 20.0~40.0 s） |
...
- 因子三（生存端）：死亡热房 F1:miniboss（9 次）。若集中于特定房型，建议校准该房型敌方弹幕密度（§7.5 上限）或弹速 -10%~15%；死亡集中于 Boss 房则复核 P2/P3 弹幕量曲线。
...
- **局间隔离**：每局 `start_run` 重置局内状态；SaveSystem 原状保留（headless 自动重定向 save_headless.json，真档不受影响）——图鉴/成就计数与 Boss 首杀标记跨局累积（真实玩家成长模拟），vine_colossus 首杀 +300 只落批次首局（逐局表「首杀可获」列可查）。m4-b3：并行实例经 `--save-suffix=<s>` 各写 `save_headless_<s>.json`（本批后缀='balg11'），消除图鉴/成就/首杀跨进程竞态。
