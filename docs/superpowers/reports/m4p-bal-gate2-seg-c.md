...
| 单局时长(均值/中位) | 3.0 / 2.6 min | 25.0~35.0 min（单局口径） | 第 1 层子集，仅参考 |

## 逐局

| seed | 结果 | 止步 | 房间 | 击杀 | 时长(min) | 金币 | 蓝晶 | 买红心 | 增益选择 | 首杀可获 | 死因 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 3451 | stalled | 第1层 | 6 | 34 | 4.7 | 9 | 5 | 0 | roll_master | 是 | - |
| 3452 | death | 第1层 | 10 | 48 | 2.8 | 86 | 5 | 0 | haggle,element_vision | 是 | 腐沼巨蟾的吐还弹幕（miniboss） |
| 3453 | death | 第1层 | 10 | 48 | 2.5 | 87 | 5 | 0 | - | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3454 | death | 第1层 | 10 | 48 | 2.4 | 85 | 5 | 0 | swift_trigger | 是 | 石盾武僧的接触冲撞（miniboss） |
| 3455 | stalled | 第1层 | 11 | 49 | 5.5 | 144 | 25 | 0 | - | 是 | - |
| 3456 | death | 第1层 | 10 | 50 | 2.3 | 73 | 5 | 0 | haggle | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3457 | stalled | 第1层 | 5 | 28 | 4.4 | 31 | 5 | 0 | shield_tune,element_vision | 是 | - |
| 3458 | death | 第1层 | 10 | 49 | 2.7 | 76 | 5 | 0 | shield_tune | 是 | 冰蛛的接触冲撞（miniboss） |
| 3459 | death | 第1层 | 11 | 50 | 3.2 | 89 | 25 | 0 | - | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3460 | death | 第1层 | 5 | 31 | 1.7 | 33 | 5 | 0 | - | 是 | 穴蝠的接触冲撞（combat） |
| 3461 | death | 第1层 | 10 | 48 | 2.2 | 79 | 5 | 0 | - | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3462 | death | 第1层 | 11 | 49 | 2.6 | 82 | 25 | 0 | - | 是 | 藤蔓巨像的巨掌拍击（boss） |
| 3463 | death | 第1层 | 10 | 48 | 2.3 | 94 | 5 | 0 | ammo_convert,resonance_vision | 是 | 石盾武僧的接触冲撞（miniboss） |
| 3464 | death | 第1层 | 11 | 52 | 2.2 | 90 | 25 | 0 | - | 是 | 自爆王虫的延迟大爆（miniboss） |
| 3465 | death | 第1层 | 11 | 50 | 3.3 | 43 | 25 | 0 | - | 是 | 藤蔓巨像的种子弹环（boss） |
| 3466 | death | 第1层 | 10 | 49 | 2.3 | 82 | 5 | 0 | haggle,shield_tune | 是 | 冰蛛的接触冲撞（miniboss） |
| 3467 | death | 第1层 | 11 | 50 | 3.5 | 92 | 25 | 0 | nerve_reflex | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3468 | death | 第1层 | 11 | 50 | 3.0 | 95 | 25 | 0 | crit_detonate,dash_extend | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3469 | death | 第1层 | 7 | 41 | 2.2 | 54 | 5 | 0 | energy_max,hunter | 是 | 藤蔓冲锋者的接触冲撞（combat） |
| 3470 | death | 第1层 | 10 | 50 | 2.7 | 90 | 5 | 0 | - | 是 | 冰蛛的接触冲撞（miniboss） |
| 3471 | death | 第1层 | 4 | 21 | 1.0 | 2 | 0 | 0 | vigor | 是 | 双刀蜥人的接触冲撞（elite） |
| 3472 | death | 第1层 | 10 | 48 | 2.4 | 89 | 5 | 0 | haggle | 是 | 石盾武僧的接触冲撞（miniboss） |
| 3473 | death | 第1层 | 11 | 53 | 2.4 | 86 | 25 | 0 | carapace | 是 | 藤蔓巨像的巨掌拍击（boss） |
| 3474 | stalled | 第1层 | 10 | 46 | 5.1 | 102 | 5 | 0 | phoenix,shield_tune | 是 | - |
| 3475 | stalled | 第1层 | 7 | 40 | 4.9 | 32 | 5 | 0 | phoenix | 是 | - |
...
|---|---|---|---|
| A1 杂兵 TTK（首次受击→死亡） | 1.9 / 5.7 s (n=898) | ≤2.0 s | 达标 |
| A1 杂兵 lifetime（入场→死亡，旧口径对照） | 3.9 / 8.2 s (n=898) | - | 对照口径 |
| 精英击杀 | 2.3 / 21.4 s (n=171) | （参考） | - |
| 小 Boss 击杀 | 2.1 / 8.2 s (n=57) | （参考） | - |
| Boss 单体击杀 | 1.6 / 1.6 s (n=4) | （参考） | - |
| 战斗房时长 | 14.2 / 25.1 s (n=137) | 20.0~40.0 s | 偏离（目标 20.0~40.0 s） |
...
- 因子三（生存端）：死亡热房 F1:miniboss（11 次）。若集中于特定房型，建议校准该房型敌方弹幕密度（§7.5 上限）或弹速 -10%~15%；死亡集中于 Boss 房则复核 P2/P3 弹幕量曲线。
...
- **局间隔离**：每局 `start_run` 重置局内状态；SaveSystem 原状保留（headless 自动重定向 save_headless.json，真档不受影响）——图鉴/成就计数与 Boss 首杀标记跨局累积（真实玩家成长模拟），vine_colossus 首杀 +300 只落批次首局（逐局表「首杀可获」列可查）。m4-b3：并行实例经 `--save-suffix=<s>` 各写 `save_headless_<s>.json`（本批后缀='balg7'），消除图鉴/成就/首杀跨进程竞态。
