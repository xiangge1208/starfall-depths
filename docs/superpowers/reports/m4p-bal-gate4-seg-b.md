...
| 单局时长(均值/中位) | 2.8 / 2.5 min | 25.0~35.0 min（单局口径） | 第 1 层子集，仅参考 |

## 逐局

| seed | 结果 | 止步 | 房间 | 击杀 | 时长(min) | 金币 | 蓝晶 | 买红心 | 增益选择 | 首杀可获 | 死因 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 3426 | death | 第1层 | 10 | 48 | 2.1 | 70 | 5 | 0 | crit_detonate,precision | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3427 | death | 第1层 | 11 | 49 | 2.5 | 155 | 25 | 0 | energy_siphon | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3428 | death | 第1层 | 11 | 50 | 3.3 | 96 | 25 | 0 | crit_detonate | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3429 | death | 第1层 | 7 | 44 | 1.8 | 16 | 5 | 0 | vigor | 是 | 苦力虫的自爆（combat） |
| 3430 | death | 第1层 | 10 | 51 | 2.8 | 103 | 5 | 0 | - | 是 | 苦力虫的自爆（miniboss） |
| 3431 | death | 第1层 | 11 | 52 | 3.4 | 111 | 25 | 0 | hunter | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3432 | death | 第1层 | 10 | 48 | 3.2 | 80 | 5 | 0 | - | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3433 | death | 第1层 | 11 | 49 | 2.4 | 143 | 25 | 0 | - | 是 | 藤蔓巨像的接触冲撞（boss） |
| 3434 | death | 第1层 | 6 | 33 | 1.5 | 11 | 0 | 0 | nerve_reflex,status_erode | 是 | 双刀蜥人的接触冲撞（elite） |
| 3435 | death | 第1层 | 11 | 50 | 3.1 | 91 | 25 | 0 | - | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3436 | death | 第1层 | 10 | 48 | 2.5 | 112 | 5 | 0 | - | 是 | 腐沼巨蟾的吐还弹幕（miniboss） |
| 3437 | stalled | 第1层 | 3 | 21 | 3.8 | 85 | 0 | 0 | phoenix | 是 | - |
| 3438 | death | 第1层 | 11 | 50 | 2.5 | 78 | 25 | 0 | swift_trigger | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3439 | death | 第1层 | 11 | 49 | 3.9 | 46 | 25 | 0 | anti_poison | 是 | 藤蔓巨像的种子弹环（boss） |
| 3440 | death | 第1层 | 11 | 55 | 2.5 | 97 | 25 | 0 | - | 是 | 自爆王虫的延迟大爆（miniboss） |
| 3441 | death | 第1层 | 10 | 48 | 2.8 | 49 | 5 | 0 | extra_projectiles | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3442 | death | 第1层 | 11 | 49 | 3.1 | 90 | 25 | 0 | deadly,avenger | 是 | 藤蔓巨像的种子弹环（boss） |
| 3443 | stalled | 第1层 | 5 | 34 | 4.9 | 40 | 5 | 0 | - | 是 | - |
| 3444 | death | 第1层 | 11 | 50 | 3.3 | 78 | 25 | 0 | shield_tune | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3445 | death | 第1层 | 10 | 48 | 2.0 | 82 | 5 | 0 | - | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3446 | death | 第1层 | 11 | 49 | 2.5 | 91 | 25 | 0 | - | 是 | 藤蔓巨像的接触冲撞（boss） |
| 3447 | death | 第1层 | 10 | 48 | 2.2 | 33 | 5 | 0 | - | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3448 | stalled | 第1层 | 11 | 53 | 5.2 | 200 | 25 | 0 | - | 是 | - |
| 3449 | death | 第1层 | 5 | 31 | 1.4 | 96 | 0 | 0 | vigor | 是 | 双刀蜥人的接触冲撞（elite） |
| 3450 | death | 第1层 | 4 | 22 | 0.9 | 6 | 0 | 0 | swift_trigger | 是 | 弩兵的弹幕（elite） |
...
|---|---|---|---|
| A1 杂兵 TTK（首次受击→死亡） | 1.6 / 5.3 s (n=833) | ≤2.0 s | 达标 |
| A1 杂兵 lifetime（入场→死亡，旧口径对照） | 3.5 / 8.1 s (n=901) | - | 对照口径 |
| 精英击杀 | 2.9 / 21.9 s (n=149) | （参考） | - |
| 小 Boss 击杀 | 2.9 / 20.8 s (n=52) | （参考） | - |
| Boss 单体击杀 | 1.3 / 1.7 s (n=7) | （参考） | - |
| 战斗房时长 | 13.6 / 24.5 s (n=138) | 20.0~40.0 s | 偏离（目标 20.0~40.0 s） |
...
- 因子三（生存端）：死亡热房 F1:boss（10 次）。若集中于特定房型，建议校准该房型敌方弹幕密度（§7.5 上限）或弹速 -10%~15%；死亡集中于 Boss 房则复核 P2/P3 弹幕量曲线。
...
- **局间隔离**：每局 `start_run` 重置局内状态；SaveSystem 原状保留（headless 自动重定向 save_headless.json，真档不受影响）——图鉴/成就计数与 Boss 首杀标记跨局累积（真实玩家成长模拟），vine_colossus 首杀 +300 只落批次首局（逐局表「首杀可获」列可查）。m4-b3：并行实例经 `--save-suffix=<s>` 各写 `save_headless_<s>.json`（本批后缀='balg14'），消除图鉴/成就/首杀跨进程竞态。
