...
| 单局时长(均值/中位) | 2.6 / 2.7 min | 25.0~35.0 min（单局口径） | 第 1 层子集，仅参考 |

## 逐局

| seed | 结果 | 止步 | 房间 | 击杀 | 时长(min) | 金币 | 蓝晶 | 买红心 | 增益选择 | 首杀可获 | 死因 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 3401 | death | 第1层 | 6 | 36 | 1.7 | 58 | 5 | 0 | - | 是 | 苦力虫的自爆（combat） |
| 3402 | death | 第1层 | 11 | 49 | 3.1 | 93 | 25 | 0 | haggle | 是 | 藤蔓巨像的藤蔓横扫（boss） |
| 3403 | stalled | 第1层 | 6 | 31 | 4.5 | 36 | 5 | 0 | - | 是 | - |
| 3404 | death | 第1层 | 10 | 48 | 2.5 | 76 | 5 | 0 | dash_extend | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3405 | death | 第1层 | 4 | 25 | 1.1 | 17 | 0 | 0 | - | 是 | 弩兵的弹幕（elite） |
| 3406 | death | 第1层 | 11 | 49 | 2.6 | 101 | 25 | 0 | energy_siphon,nerve_reflex | 是 | 藤蔓巨像的巨掌拍击（boss） |
| 3407 | stalled | 第1层 | 5 | 25 | 4.3 | 7 | 5 | 0 | - | 是 | - |
| 3408 | death | 第1层 | 10 | 48 | 2.5 | 75 | 5 | 0 | quick_charge | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3409 | death | 第1层 | 10 | 48 | 3.0 | 86 | 5 | 0 | vigor | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3410 | death | 第1层 | 10 | 48 | 2.7 | 96 | 5 | 0 | - | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3411 | death | 第1层 | 11 | 50 | 3.1 | 98 | 25 | 0 | resonance_vision | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3412 | death | 第1层 | 11 | 50 | 3.0 | 84 | 25 | 0 | - | 是 | 藤蔓巨像的种子弹环（boss） |
| 3413 | death | 第1层 | 3 | 25 | 1.0 | 7 | 0 | 0 | status_erode | 是 | 双刀蜥人的接触冲撞（elite） |
| 3414 | death | 第1层 | 11 | 49 | 2.6 | 103 | 25 | 0 | haggle | 是 | 藤蔓巨像的巨掌拍击（boss） |
| 3415 | death | 第1层 | 11 | 51 | 3.5 | 77 | 25 | 0 | fire_enchant,nerve_reflex | 是 | 藤蔓巨像的毒雨（boss） |
| 3416 | death | 第1层 | 11 | 50 | 3.0 | 57 | 25 | 0 | - | 是 | 藤蔓巨像的藤蔓横扫（boss） |
| 3417 | death | 第1层 | 10 | 54 | 2.3 | 76 | 5 | 0 | roll_master | 是 | 苦力虫的自爆（miniboss） |
| 3418 | death | 第1层 | 6 | 33 | 1.4 | 18 | 0 | 0 | ammo_convert,carapace | 是 | 藤蔓冲锋者的接触冲撞（elite） |
| 3419 | death | 第1层 | 11 | 53 | 2.7 | 132 | 25 | 0 | - | 是 | 藤蔓巨像的藤蔓横扫（boss） |
| 3420 | death | 第1层 | 11 | 54 | 2.8 | 69 | 25 | 0 | roll_master,status_erode | 是 | 藤蔓巨像的藤蔓横扫（boss） |
| 3421 | death | 第1层 | 11 | 53 | 2.2 | 107 | 25 | 0 | deadly,vigor | 是 | 藤蔓巨像的接触冲撞（miniboss） |
| 3422 | death | 第1层 | 11 | 50 | 2.8 | 92 | 25 | 0 | bullet_speed | 是 | 藤蔓巨像的藤蔓横扫（boss） |
| 3423 | death | 第1层 | 11 | 49 | 3.4 | 29 | 25 | 1 | element_vision | 是 | 藤蔓巨像的藤蔓横扫（boss） |
| 3424 | death | 第1层 | 10 | 48 | 2.1 | 88 | 5 | 0 | thorn_armor,thorn_armor | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3425 | death | 第1层 | 4 | 24 | 0.9 | 3 | 0 | 0 | haggle | 是 | 双刀蜥人的接触冲撞（elite） |
...
|---|---|---|---|
| A1 杂兵 TTK（首次受击→死亡） | 1.8 / 5.2 s (n=869) | ≤2.0 s | 达标 |
| A1 杂兵 lifetime（入场→死亡，旧口径对照） | 3.8 / 7.9 s (n=869) | - | 对照口径 |
| 精英击杀 | 2.0 / 18.6 s (n=158) | （参考） | - |
| 小 Boss 击杀 | 1.6 / 20.1 s (n=63) | （参考） | - |
| Boss 单体击杀 | 1.5 / 1.5 s (n=7) | （参考） | - |
| 战斗房时长 | 13.4 / 24.4 s (n=133) | 20.0~40.0 s | 偏离（目标 20.0~40.0 s） |
...
- **局间隔离**：每局 `start_run` 重置局内状态；SaveSystem 原状保留（headless 自动重定向 save_headless.json，真档不受影响）——图鉴/成就计数与 Boss 首杀标记跨局累积（真实玩家成长模拟），vine_colossus 首杀 +300 只落批次首局（逐局表「首杀可获」列可查）。m4-b3：并行实例经 `--save-suffix=<s>` 各写 `save_headless_<s>.json`（本批后缀='balg1'），消除图鉴/成就/首杀跨进程竞态。
