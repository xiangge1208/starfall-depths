...
| 单局时长(均值/中位) | 2.8 / 2.7 min | 25.0~35.0 min（单局口径） | 第 1 层子集，仅参考 |

## 逐局

| seed | 结果 | 止步 | 房间 | 击杀 | 时长(min) | 金币 | 蓝晶 | 买红心 | 增益选择 | 首杀可获 | 死因 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 3401 | death | 第1层 | 11 | 50 | 3.3 | 95 | 25 | 0 | - | 是 | 藤蔓巨像的种子弹环（boss） |
| 3402 | death | 第1层 | 11 | 49 | 2.8 | 80 | 25 | 0 | haggle | 是 | 藤蔓巨像的接触冲撞（boss） |
| 3403 | death | 第1层 | 5 | 29 | 1.5 | 4 | 0 | 0 | - | 是 | 双刀蜥人的接触冲撞（elite） |
| 3404 | death | 第1层 | 10 | 48 | 2.8 | 91 | 5 | 0 | dash_extend | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3405 | death | 第1层 | 10 | 50 | 2.4 | 87 | 5 | 0 | - | 是 | 冰蛛的接触冲撞（miniboss） |
| 3406 | death | 第1层 | 11 | 50 | 3.2 | 92 | 25 | 0 | energy_siphon,nerve_reflex | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3407 | death | 第1层 | 10 | 48 | 2.7 | 45 | 5 | 0 | - | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3408 | death | 第1层 | 10 | 48 | 3.3 | 61 | 5 | 0 | quick_charge | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3409 | death | 第1层 | 2 | 10 | 0.6 | 3 | 0 | 0 | - | 是 | 弩兵的弹幕（elite） |
| 3410 | death | 第1层 | 10 | 48 | 2.6 | 82 | 5 | 0 | - | 是 | 腐沼巨蟾的接触冲撞（miniboss） |
| 3411 | death | 第1层 | 11 | 50 | 3.2 | 89 | 25 | 0 | resonance_vision | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3412 | death | 第1层 | 7 | 45 | 2.1 | 44 | 5 | 0 | - | 是 | 弩兵的弹幕（combat） |
| 3413 | death | 第1层 | 11 | 53 | 2.2 | 63 | 25 | 0 | status_erode | 是 | 藤蔓巨像的巨掌拍击（boss） |
| 3414 | death | 第1层 | 11 | 49 | 2.7 | 80 | 25 | 0 | haggle | 是 | 藤蔓巨像的种子弹环（boss） |
| 3415 | death | 第1层 | 11 | 49 | 2.6 | 88 | 25 | 0 | fire_enchant,nerve_reflex | 是 | 藤蔓巨像的接触冲撞（boss） |
| 3416 | death | 第1层 | 11 | 50 | 3.6 | 100 | 25 | 0 | - | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3417 | death | 第1层 | 2 | 12 | 0.5 | 2 | 0 | 0 | - | 是 | 藤蔓冲锋者的接触冲撞（combat） |
| 3418 | death | 第1层 | 11 | 53 | 2.4 | 71 | 25 | 0 | ammo_convert,carapace | 是 | 藤蔓巨像的巨掌拍击（boss） |
| 3419 | stalled | 第1层 | 5 | 34 | 4.8 | 33 | 5 | 0 | - | 是 | - |
| 3420 | death | 第1层 | 11 | 55 | 3.2 | 95 | 25 | 0 | roll_master,status_erode | 是 | 藤蔓巨像的毒雨（boss） |
| 3421 | stalled | 第1层 | 10 | 46 | 5.3 | 105 | 5 | 0 | deadly,vigor | 是 | - |
| 3422 | stalled | 第1层 | 3 | 15 | 3.6 | 0 | 0 | 0 | - | 是 | - |
| 3423 | death | 第1层 | 11 | 50 | 3.4 | 40 | 25 | 0 | element_vision | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3424 | death | 第1层 | 10 | 48 | 2.2 | 86 | 5 | 0 | thorn_armor,thorn_armor | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3425 | death | 第1层 | 10 | 48 | 2.3 | 98 | 5 | 0 | haggle,nerve_reflex | 是 | 石盾武僧的接触冲撞（miniboss） |
...
|---|---|---|---|
| A1 杂兵 TTK（首次受击→死亡） | 2.0 / 5.8 s (n=863) | ≤2.0 s | 达标 |
| A1 杂兵 lifetime（入场→死亡，旧口径对照） | 3.8 / 8.5 s (n=863) | - | 对照口径 |
| 精英击杀 | 2.4 / 19.8 s (n=156) | （参考） | - |
| 小 Boss 击杀 | 2.0 / 20.0 s (n=59) | （参考） | - |
| Boss 单体击杀 | 1.3 / 1.4 s (n=7) | （参考） | - |
| 战斗房时长 | 14.7 / 24.4 s (n=132) | 20.0~40.0 s | 偏离（目标 20.0~40.0 s） |
...
- **局间隔离**：每局 `start_run` 重置局内状态；SaveSystem 原状保留（headless 自动重定向 save_headless.json，真档不受影响）——图鉴/成就计数与 Boss 首杀标记跨局累积（真实玩家成长模拟），vine_colossus 首杀 +300 只落批次首局（逐局表「首杀可获」列可查）。m4-b3：并行实例经 `--save-suffix=<s>` 各写 `save_headless_<s>.json`（本批后缀='balg5'），消除图鉴/成就/首杀跨进程竞态。
