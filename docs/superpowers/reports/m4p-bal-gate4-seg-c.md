...
| 单局时长(均值/中位) | 2.6 / 2.4 min | 25.0~35.0 min（单局口径） | 第 1 层子集，仅参考 |

## 逐局

| seed | 结果 | 止步 | 房间 | 击杀 | 时长(min) | 金币 | 蓝晶 | 买红心 | 增益选择 | 首杀可获 | 死因 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 3451 | death | 第1层 | 11 | 50 | 1.8 | 157 | 25 | 0 | roll_master | 是 | 藤蔓巨像的毒雨（boss） |
| 3452 | death | 第1层 | 5 | 32 | 1.3 | 8 | 0 | 0 | haggle,element_vision | 是 | 双刀蜥人的接触冲撞（elite） |
| 3453 | death | 第1层 | 4 | 32 | 1.7 | 6 | 0 | 0 | - | 是 | 双刀蜥人的接触冲撞（elite） |
| 3454 | death | 第1层 | 11 | 50 | 5.1 | 126 | 25 | 1 | swift_trigger | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3455 | death | 第1层 | 7 | 45 | 2.1 | 30 | 5 | 0 | - | 是 | 苦力虫的自爆（combat） |
| 3456 | death | 第1层 | 10 | 48 | 2.2 | 171 | 5 | 0 | haggle | 是 | 冰蛛的接触冲撞（miniboss） |
| 3457 | death | 第1层 | 11 | 50 | 3.3 | 111 | 25 | 1 | shield_tune,element_vision | 是 | 藤蔓巨像的种子弹环（boss） |
| 3458 | death | 第1层 | 10 | 52 | 2.6 | 178 | 5 | 0 | shield_tune | 是 | 冰蛛的接触冲撞（miniboss） |
| 3459 | death | 第1层 | 4 | 26 | 1.1 | 112 | 0 | 0 | - | 是 | 弩兵的弹幕（elite） |
| 3460 | death | 第1层 | 5 | 32 | 1.7 | 16 | 5 | 0 | - | 是 | 苦力虫的自爆（combat） |
| 3461 | death | 第1层 | 7 | 41 | 1.8 | 96 | 5 | 0 | - | 是 | 弩兵的弹幕（combat） |
| 3462 | death | 第1层 | 11 | 50 | 3.6 | 106 | 25 | 0 | - | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3463 | death | 第1层 | 11 | 51 | 4.4 | 92 | 25 | 0 | ammo_convert,resonance_vision | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3464 | death | 第1层 | 11 | 56 | 1.6 | 161 | 25 | 0 | - | 是 | 自爆王虫的延迟大爆（miniboss） |
| 3465 | stalled | 第1层 | 3 | 18 | 3.7 | 0 | 0 | 0 | - | 是 | - |
| 3466 | death | 第1层 | 10 | 48 | 2.8 | 164 | 5 | 0 | haggle,shield_tune | 是 | 电磁蛛的接触冲撞（miniboss） |
| 3467 | death | 第1层 | 11 | 55 | 3.9 | 182 | 25 | 0 | nerve_reflex | 是 | 藤蔓巨像的毒雨（boss） |
| 3468 | death | 第1层 | 11 | 52 | 3.3 | 103 | 25 | 0 | crit_detonate,dash_extend | 是 | 蘑菇孢子手的减速孢子扇（boss） |
| 3469 | death | 第1层 | 11 | 52 | 3.8 | 42 | 25 | 0 | energy_max,hunter | 是 | 藤蔓巨像的藤蔓横扫（boss） |
| 3470 | death | 第1层 | 10 | 52 | 2.4 | 87 | 5 | 0 | - | 是 | 冰蛛的接触冲撞（miniboss） |
| 3471 | death | 第1层 | 10 | 48 | 2.5 | 170 | 5 | 0 | vigor | 是 | 腐沼巨蟾的吐还弹幕（miniboss） |
| 3472 | death | 第1层 | 10 | 48 | 2.4 | 81 | 5 | 0 | haggle | 是 | 石盾武僧的接触冲撞（miniboss） |
| 3473 | death | 第1层 | 11 | 53 | 2.2 | 161 | 25 | 0 | carapace | 是 | 藤蔓巨像的接触冲撞（boss） |
| 3474 | death | 第1层 | 3 | 26 | 1.2 | 6 | 0 | 0 | phoenix,shield_tune | 是 | 双刀蜥人的接触冲撞（elite） |
| 3475 | death | 第1层 | 10 | 48 | 2.2 | 56 | 5 | 0 | phoenix | 是 | 电磁蛛的接触冲撞（miniboss） |
...
|---|---|---|---|
| A1 杂兵 TTK（首次受击→死亡） | 1.6 / 5.7 s (n=834) | ≤2.0 s | 达标 |
| A1 杂兵 lifetime（入场→死亡，旧口径对照） | 3.5 / 8.6 s (n=874) | - | 对照口径 |
| 精英击杀 | 2.4 / 18.3 s (n=148) | （参考） | - |
| 小 Boss 击杀 | 1.7 / 22.4 s (n=51) | （参考） | - |
| Boss 单体击杀 | 1.2 / 3.7 s (n=17) | （参考） | - |
| 战斗房时长 | 14.4 / 25.9 s (n=132) | 20.0~40.0 s | 偏离（目标 20.0~40.0 s） |
...
- 因子三（生存端）：死亡热房 F1:boss（9 次）。若集中于特定房型，建议校准该房型敌方弹幕密度（§7.5 上限）或弹速 -10%~15%；死亡集中于 Boss 房则复核 P2/P3 弹幕量曲线。
...
- **局间隔离**：每局 `start_run` 重置局内状态；SaveSystem 原状保留（headless 自动重定向 save_headless.json，真档不受影响）——图鉴/成就计数与 Boss 首杀标记跨局累积（真实玩家成长模拟），vine_colossus 首杀 +300 只落批次首局（逐局表「首杀可获」列可查）。m4-b3：并行实例经 `--save-suffix=<s>` 各写 `save_headless_<s>.json`（本批后缀='balg15'），消除图鉴/成就/首杀跨进程竞态。
